if (!window.LChart) {
    ...
    LChart.Const.Skins.BlackAndWhite.Ring = {
...
LChart.Ring = LChart.getCore().__extends({ GraphType: 'Ring' });
LChart.Ring._spreadSkin = function (newOps, skin) {
...
LChart.Ring._getDefaultOptions = function (originalCommonOptions) {
...
LChart.Ring._getCheckOptions = function () {
    return {
...
LChart.Ring._drawgraphic = function (inner, graphicID, innerData, options) {
