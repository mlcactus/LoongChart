...
LChart.Ring3D._drawgraphic = function (inner, graphicID, innerData, options) {
    ...
    var outerLabelShape = function (content, length, width, height, floatright, floattop, data, contact) {
        ...
        this.resetposition = function () {
            ...
            this.startX = (floattop ? computeinfo.centerX : (computeinfo.centerX + computeinfo.darkCenterX) / 2) + pieOuterRadius * cosmid;
            this.startY = (floattop ? computeinfo.centerY : (computeinfo.centerY + computeinfo.darkCenterY) / 2) + pieOuterRadius * sinmid;
