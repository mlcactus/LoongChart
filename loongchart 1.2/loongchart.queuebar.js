if (!window.LChart) {
    ...
    LChart.Const.Skins.BlackAndWhite.QueueBar = {
        LabelColor: null
    };
}
LChart.QueueBar = LChart.getCore().__extends({ GraphType: 'QueueBar' });
LChart.QueueBar._spreadSkin = function (newOps, skin) {
    newOps.label = {};
    newOps.label.color = skin.LabelColor || null;
};
LChart.QueueBar._getDefaultOptions = function (originalCommonOptions) {
...
LChart.QueueBar._getCheckOptions = function () {
    return {
...
LChart.QueueBar._drawgraphic = function (inner, graphicID, innerData, options) {
