if (!window.LChart) {
    ...
    LChart.Const.Skins.BlackAndWhite.Area = {
        NodeLineColor: '#ffffff',
        AlignlineLineColor: null
    };
}
LChart.Area = LChart.getCore().__extends({ GraphType: 'Area' });
LChart.Area._spreadSkin = function (newOps, skin) {
...
LChart.Area._getDefaultOptions = function (originalCommonOptions) {
...
LChart.Area._getCheckOptions = function () {
    return {
        __top: [['invertAxis', 'b']],
...
LChart.Area._drawgraphic = function (inner, graphicID, innerData, options) {
